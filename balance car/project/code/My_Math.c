...
//------------------------------------------------------------------------------
//  @brief      float myMath_fast_atan2(float y, float x)
//  @param
//  Sample usage:
//------------------------------------------------------------------------------
float myMath_fast_atan2(float y, float x)
{
    ...
    else
    {
        ...
        if (z < MYMATH_TAN_MAP_RES){
            base_angle = z;
        }
        else
        {
            /* find index and interpolation value */
            alpha = z * (float) MYMATH_TAN_MAP_SIZE - .5f;
            index = (int) alpha;
            alpha -= (float) index;
...
//------------------------------------------------------------------------------
//  @brief      myMath_atan(float x, float y)
//  @param
//  Sample usage:
//------------------------------------------------------------------------------
float myMath_atan(float x, float y)
{
    return myMath_fast_atan2(y, x);
}

//------------------------------------------------------------------------------
//  @brief      float myMath_sin(float rad)
//  @param
//  Sample usage:
//------------------------------------------------------------------------------
...
float myMath_sin(float rad)
{
    ...
    if (rad >= MYMATH_ONE_PI)
    {
        rad -= MYMATH_ONE_PI;
        flag = -1;
    }

    return myMath_mx_sin(rad) * flag;
}

//------------------------------------------------------------------------------
//  @brief      float myMath_cos(float rad)
//  @param
//  Sample usage:
//------------------------------------------------------------------------------
